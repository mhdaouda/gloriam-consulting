            ...
            return (
              ...
              >
                ...
                <div className="relative h-64 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
                  {project.image && (project.image.includes('construction.jpeg') || project.image.includes('paiements.png') || project.image.includes('StationService.png') || project.image.includes('assurances.jpg') || project.image.includes('flux.jpg') || project.image.includes('odm.jpg')) ? (
                    <>
                      <Image
                        src={project.image}
                        alt={project.title}
        ...
        >
          <div className="mx-auto max-w-2xl rounded-2xl bg-gradient-to-br from-emerald-600 via-teal-600 to-emerald-600 p-8 shadow-2xl">
            ...
            <p className="mb-6 text-lg text-emerald-50">
              Contactez-nous pour discuter de votre projet et découvrez comment nous pouvons vous accompagner.
            </p>
            <motion.a
              href="/fr/contact"
