...
export function PageHero({ title, description, eyebrow }: PageHeroProps) {
  return (
    <section className="relative overflow-hidden border-b border-slate-200/80 bg-gradient-to-br from-emerald-50/80 via-white to-cyan-50/60 py-20 dark:border-white/[0.06] dark:bg-transparent">
